...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_67d7_2b41_c267_f02a_e67f_2c34_14b9_0c8e',
  ...
  SUDO: process.env.SUDO || '+918943076174',
  STARTING_MSG: toBool(process.env.STARTING_MSG) || true,
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '⥃𝐗𝟒𝄞⃝ ❤️𝐍𝐀𝐍𝐁𝐀𝐍𝄞⃝  ♛;⥃𝐗𝟒𝄞⃝😈ESPORTS𝄞⃝  ♛;https://graph.org/file/1506e5842805b0968c5cf.mp4',
