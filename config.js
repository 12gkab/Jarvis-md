...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_c1d0_0b45_51fd_bb29_fa3e_b0de_8415_19d7',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "⥃𝐗𝟒𝄞⃝ ❤️𝐍𝐀𝐍𝐁𝐀𝐍𝄞⃝  ♛", "body": "⥃𝐗𝟒𝄞⃝ ❤️ESPORTS𝄞⃝  ♛", "thumbnailUrl": "https://i.imgur.com/Rgrh3NQ.jpeg", "renderLargerThumbnail": true, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis-md", "showAdAttribution": true}`,
  KOYEB_API: process.env.KOYEB_API,
  BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
  TGTOKEN: "bot891038791:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4",
  API: 'https://api-loki-ser-1o2h.onrender.com/',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '⥃𝐗𝟒𝄞⃝ ❤️𝐍𝐀𝐍𝐁𝐀𝐍𝄞⃝  ♛',
  ...
  SUDO: process.env.SUDO || '+918943076174,+917025443917,+919947664685',
  STARTING_MSG: toBool(process.env.STARTING_MSG) || true,
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '⥃𝐗𝟒𝄞⃝❤️𝐍𝐀𝐍𝐁𝐀𝐍𝄞⃝  ♛;⥃𝐗𝟒𝄞⃝😈𝐍𝐀𝐍𝐁𝐀𝐍𝄞⃝  ♛;https://graph.org/file/1506e5842805b0968c5cf.mp4',
